...
public enum AiModel {
    ...
    GEMINI_3_5_FLASH("gemini-3.5-flash", AiProvider.GOOGLE, 150),
    GEMINI_3_5_FLASH_LITE("gemini-3.5-flash-lite", AiProvider.GOOGLE, 100),
    ...
    GEMINI_3_FLASH("gemini-3-flash", AiProvider.GOOGLE, 70),
    GEMINI_2_5_FLASH("gemini-2.5-flash", AiProvider.GOOGLE, 60),
    GEMINI_2_5_FLASH_LITE("gemini-2.5-flash-lite", AiProvider.GOOGLE, 40),
